...
- [Onboarding Guide](Onboarding/Onboarding_Guide.md)
  ...
  - [Kick-off Guide](Onboarding/Kickoff_Guide.md)
  - [Develop Scenario](Onboarding/Developers_Guide.md)
    - [Provision](OCP_CI_Tutorials/Scenarios/Provision_Guide.md)
    - [Orchestrate](OCP_CI_Tutorials/Scenarios/Orchestration_Guide.md)
    - [Execute](OCP_CI_Tutorials/Scenarios/Execution_Guide.md)
    - [Report](OCP_CI_Tutorials/Scenarios/Reporting_Guide.md)
    - [Document](Policy/Documentation/Scenario_Documentation_Policy.md)
  - [Maintenance & Expansion Guide](Policy/Maintenance/Scenario_Maintenance_Policy.md)
...
- [Documentation](Policy/Documentation/Documentation_Policy.md)
...
- [Maintenance](Policy/Maintenance/Scenario_Maintenance_Policy.md)
