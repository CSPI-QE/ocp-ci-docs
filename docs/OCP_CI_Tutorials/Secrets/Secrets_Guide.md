...
7. Add the desired key/value pair(s) to the secret for use during execution.
   ...
   - > IMPORTANT SECURITY INFORMATION:
     - We'll be covering information from the official [OpenShift CI secret docs here](https://docs.ci.openshift.org/docs/how-tos/adding-a-new-secret-to-ci/#good-practice)
